...
export function EditModal({ destination }) {
    ...
    return (
        <Modal>
                ...
                <Button
                    variant="outline"
                    className="rounded-none flex items-center gap-2 px-6 py-2.5 rounded-2xl border border-gray-300 text-gray-700 hover:bg-black hover:text-white hover:border-black transition-all duration-300 shadow-sm hover:shadow-md"
                >
                    <Edit size={18} />
                    Edit
                </Button>
